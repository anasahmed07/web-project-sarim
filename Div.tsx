...
<div className="relative text-center mb-12">
  <div
    className="absolute top-0 left-1/3 transform -translate-x-1/2 -translate-y-1/2 
               text-white/10 text-6xl font-bold z-0 pointer-events-none whitespace-nowrap"
  >
    Cutting Edge Digital Solutions
          ...
          <div className="relative z-10 animate-fade-in-up top-0 left-0 right-0 mx-auto text-center py-2">
            <h2 className="heading-md text-white font-extralight text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center mb-6">
              We Empower Global Leaders <br />
              <span className="text-white">Through Digital Engineering</span>
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {clients.map((client, index) => (
            ...
            >
              <div className="w-12 h-12 rounded-full bg-dark-700 flex items-center justify-center text-orange font-bold mb-4">
                {client.logo}
              </div>
  ...
  <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    {/* Left Section - Image + Floating Card */}
    <div className="relative w-auto z-0">
      ...
      {/* Floating Card - Now Positioned on Top of Image */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black/70 backdrop-blur-md border border-white/20 p-6 rounded-xl w-72 shadow-lg text-white"
      >
        <h3 className="text-2xl font-bold mb-2">
          Clut<span className="text-red-500">c</span>h
        </h3>
        <p className="text-sm text-white/80">
          Jump into the innovation hub! Transform your idea into a groundbreaking
          digital solution with a strategic approach.
        </p>
      </motion.div>
    </div>
