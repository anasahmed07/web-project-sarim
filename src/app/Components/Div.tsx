...
<div className="relative text-center mb-32">
  ...
  {/* Orange Box */}
  <div className="bg-orange-600 w-1/3 min-h-0.5 mx-auto mr-1"></div>
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-16">
          ...
          {/* Right Section */}
          <div className="w-full md:w-1/2 bg-gray-700 rounded-xl p-8">
    ...
    {/* Partners Section */}
    <div className="grid grid-cols-1 lg:grid-cols-2 px-4 md:px-6">
    {/* Left Section - Image + Floating Card */}
    <div className="relative left-56 z-0">
      {/* Main Image */}
      <Image
